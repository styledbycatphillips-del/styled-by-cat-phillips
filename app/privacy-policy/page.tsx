    ...
    <div className="min-h-screen bg-signature-cream py-16">
      <div className="container mx-auto max-w-4xl px-6">
        ...
        <div className="prose prose-lg max-w-none text-signature-navy">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">2) What we collect</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                <a href="https://support.google.com/analytics/answer/9976101" className="text-champagne hover:underline ml-1" target="_blank" rel="noopener">
                  (Google Help)
                </a>
              </li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">4) Legal bases (EEA/UK visitors)</h2>
            <p>
              ...
              <a href="https://gdpr-info.eu/art-6-gdpr/" className="text-champagne hover:underline ml-1" target="_blank" rel="noopener">
                (GDPR Article 6)
              </a>
            </p>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">5) Cookies and consent</h2>
            <p>
            ...
            <p className="mt-2">
              See the <a href="/cookie-policy" className="text-champagne hover:underline">Cookie Policy</a> for details.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">6) Sharing</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">7) Retention</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">8) International transfers</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">9) Your rights</h2>
            <p className="mb-4">
            ...
            <p>
              ...
              <a href="https://oag.ca.gov/privacy/ccpa" className="text-champagne hover:underline ml-1" target="_blank" rel="noopener">
                (CA Attorney General)
              </a>
            </p>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">10) Children's privacy</h2>
            <p>
              ...
              <a href="https://www.ftc.gov/enforcement/rules/rulemaking-regulatory-reform-proceedings/childrens-online-privacy-protection-rule" className="text-champagne hover:underline ml-1" target="_blank" rel="noopener">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">11) Security</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">12) Links</h2>
            <p>Third-party sites have their own policies.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">13) Changes</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-navy mb-4">14) Contact</h2>
            <p>
        ...
        <footer className="mt-12 pt-8 border-t border-champagne/20">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              <a href="/cookie-policy" className="text-champagne hover:underline">
                Cookie Policy
              </a>
