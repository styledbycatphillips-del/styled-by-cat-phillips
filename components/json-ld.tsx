'use client';   import { siteConfig } from '@/config/site'



export default function JsonLd({ data }: { data: object }) {export function JsonLd() {

  if (!data) return null;  const organizationSchema = {

  return (    "@context": "https://schema.org",

    <script    "@type": "ProfessionalService",

      type="application/ld+json"    "@id": siteConfig.url + "#organization",

      dangerouslySetInnerHTML={{ __html: JSON.stringify(data) }}    "name": siteConfig.business.name,
