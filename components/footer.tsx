      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-2 space-y-4">
            <Image
              src="/brand/logos/KIRKSEY%20HOUSE%20logo%20wordmark%20dark.svg"
            ...
            <p className="max-w-md text-sm text-signature-navy/80">
              Arkansas&apos;s premier presence engineering studio. We build authentic executive presence through
              wardrobe, voice, and platform alignment.
            </p>
            <div className="flex items-center gap-6 text-sm text-signature-navy/80">
              <a href={`mailto:${siteConfig.links.email}`} className="hover:text-signature-black transition-colors">
                {siteConfig.links.email}
              </a>
              <a href={`tel:${siteConfig.links.phone}`} className="hover:text-signature-black transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-signature-navy/80">
              <li>
                <Link href="#services" className="hover:text-signature-black transition-colors">
            ...
            <ul className="space-y-2 text-sm text-signature-navy/80">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="hover:text-signature-black transition-colors"
                >
                  Instagram
                </a>
              </li>
